...
//  first we are finding all of the elements that have a class of scroll-in-from-bottom
const inFromLeft = document.querySelectorAll(".scroll-in-from-left")

// for each of them we are going to attach a gsap animation ( like a jekyll for loop just in js :D )
inFromLeft.forEach(object => {
gsap.set(object,{
    position: "relative",
})
// we start with a gsap timeline
...
//  first we are finding all of the elements that have a class of scroll-in-from-bottom
const inFromRight = document.querySelectorAll(".scroll-in-from-right")

// for each of them we are going to attach a gsap animation ( like a jekyll for loop just in js :D )
inFromRight.forEach(object => {
gsap.set(object,{
    position: "relative",
})
// we start with a gsap timeline
...
//  first we are finding all of the elements that have a class of scroll-in-from-bottom
const inFromRightHeading = document.querySelectorAll(".scroll-in-from-right-heading")

// for each of them we are going to attach a gsap animation ( like a jekyll for loop just in js :D )
inFromRightHeading.forEach(object => {
gsap.set(object,{
    position: "relative",
})
// we start with a gsap timeline
